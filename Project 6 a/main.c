...
//------------------------------------------------------------------------------
  while(ALWAYS) {                       // Can the Operating system run
    ...
    if (Last_Time_Sequence != Time_Sequence) {  //update time
        ...
        //strcpy(display_line[1], "   time   ");
        //strcpy(display_line[2], "   0x01   ");
        //display_changed = TRUE;
    }
    else {
        //strcpy(display_line[1], "   time   ");
        //strcpy(display_line[2], "   0x00   ");
        //display_changed = TRUE;
    }
    ...
    case SWITCH_1:                       //straight
       /*
        ...
        switch (Shape_Count) {
            case 0:
                strcpy(display_line[0], "  1_S For ");
                strcpy(display_line[1], "    Not   ");
                strcpy(display_line[2], "  Running ");
                display_changed = TRUE;
                break;
            case 1:
                strcpy(display_line[0], " 2_S BACK ");
                strcpy(display_line[1], "    Not   ");
                strcpy(display_line[2], "  Running ");
                display_changed = TRUE;
                break;
            case 2:
                strcpy(display_line[0], "  PROJ 5  ");
                strcpy(display_line[1], "    Not   ");
                strcpy(display_line[2], "  Running ");
                display_changed = TRUE;
                break;
