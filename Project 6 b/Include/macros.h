...
#define TB0CCR0_INTERVAL (2500) //8,000,000/2/8/[1/5ms]
#define FIFTY_MS_COUNT (100)
#define FOUR_FIFTY_MS_COUNT (4)
#define TWO_HUNDRED_MS_COUNT (3)
#define TB0CCR1_INTERVAL (500000) //1/1000 ms ==1/ 1 sec
#define TB0CCR2_INTERVAL (500000) //1/1000 ms
#define TB0CCR3_INTERVAL (25000) //1/50 ms
...
#define LEFT_BLACK (0x0040)
#define RIGHT_BLACK (0x0078)
...
extern unsigned int ADC_Left_Shift;
extern unsigned int ADC_Right_Shift;
extern unsigned int ADC_Thumb_Shift;
