...
extern unsigned char Process_Buffer[4][34];
extern unsigned char tx_buffer[34];
extern volatile unsigned char tx_hold[34];
extern unsigned int buffer_row;
#define BEGINNING (0x00) //start of IOT_2_PC

extern volatile unsigned char IOT_2_PC[32];
...
extern volatile unsigned char command_rx[32];
extern volatile unsigned char command_tx[32];
extern volatile unsigned int c_rx_wr;
extern volatile unsigned int c_rx_rd;
extern volatile unsigned int c_rx_index;
extern volatile unsigned int c_tx_wr;
extern volatile unsigned int c_tx_index;
