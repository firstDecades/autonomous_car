...
// Ports
void Init_Ports(unsigned int enable);
void Init_Port1(unsigned int enable);
void Init_Port2(void);
//void Init_Port3(char smclk);
void Init_Port3(unsigned int enable);
void Init_Port4(unsigned int enable);
void Init_Port5(unsigned int enable);
