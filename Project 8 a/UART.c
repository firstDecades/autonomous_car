...
__interrupt void eUSCI_A0_ISR(void) {
    ...
    case 4:
        ...
        //break;
        P6OUT ^= GRN_LED;
        //UCA0TXBUF = tx_buffer[direct_iot++];
...
__interrupt void eUSCI_A1_ISR(void) {
    ...
    case 2:
        ...
        display_line[3][temp] = PC_2_IOT[temp];
    ...
    case 4:
        ...
        if (tx_buffer[tx_index] == NULL_CHAR) {
            UCA1IE &= ~UCTXIE;
        }
        if (tx_buffer[tx_index] == LINE_FEED) {
            UCA1IE &= ~UCTXIE;
        }
...
void LCD_update_Buadrate(void) {
    switch(Baudrate) {
    case 4:
        strcpy(display_line[0], "br: 115200");
        display_changed = TRUE;
        break;
    case 17:
        strcpy(display_line[0], "br: 460800");
        display_changed = TRUE;
        break;
    default:
        break;
