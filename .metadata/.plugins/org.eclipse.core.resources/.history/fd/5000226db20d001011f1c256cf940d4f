...
//------------------------------------------------------------------------------
  while(ALWAYS) {                       // Can the Operating system run
    ...
    timer_line(3,5);
    //display_line[1][0] = Process_Buffer[0][0];
    //display_line[1][1] = Process_Buffer[0][1];
    //display_line[1][2] = Process_Buffer[0][2];
    //display_line[1][3] = Process_Buffer[0][3];
    //display_line[1][4] = Process_Buffer[0][4];
    //display_line[1][5] = Process_Buffer[0][5];
    //display_line[1][6] = Process_Buffer[0][6];
    //display_line[1][7] = Process_Buffer[0][7];
    //display_changed = TRUE;
...
void Add_To_Buffer(void) {
    display_line[2][0] = direct_usb + 0x30;
    display_line[2][3] = usb_rx_wr + 0x30;
    display_changed = TRUE;
    if (usb_rx_wr != direct_usb) {
        //LCD_BACKLITE_DIMING = PERCENT_80;
        //direct_usb ++;
        ...
        Process_Buffer[buffer_row][direct_usb] = PC_2_IOT[direct_usb];
